...
\begin{document}
	...
	\begin{multicols}{3}
		...
		$\set V$ to be a vector space. Then: 
		\begin{align*}
			a \in V \implies\, & v = v_0 + at \\
			a \in V \implies\, & x = x_0 + v_0t + \frac{1}{2}at^2 \\
			a \in V \implies\, & x = x_0 + \frac{v_0 + v}{2}t \\
			a \in V \implies\, & v = \sqrt{v_0^2 + 2a(x - x_0)} 
		\end{align*}
		...
		\[ \exists c \, \forall i \co \frac{T_i^2}{r_i^3} = c \]
		...
		\[ \vec J = \vec F \cdot \Dg t = \int F \dt \quad \csb{\frac{\mathrm{kg}\,m}{\sec}} \]
